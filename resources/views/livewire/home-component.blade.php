        ...
        <div class="wrap-main-slide">
            <div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true"
                ...
                @foreach ($sliders as $slider)
                    <div class="item-slide" style="width: 100%; height: 600px;">
                        <a href="{{$slider->link}}">
                            <img src="{{ asset('assets/images/sliders/'.$slider->image) }}" alt="{{$slider->title}}" class="img-slide" style="object-fit: cover; object-position: 0 -5px;">
