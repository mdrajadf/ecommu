...
<<<<<<< HEAD
                            <a href="index.html" class="link-to-home"><img style="border: 1px solid border-radius: 4px width: 250px"
                                    src="{{ asset('assets/images/Moona_Hoshinova_logo_by_Ryo_Hiiragi.webp') }}" alt="moonmoon"></a>
=======
